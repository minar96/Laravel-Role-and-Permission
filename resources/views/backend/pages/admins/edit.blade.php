	    ...
	    <div class="row align-items-center">
	        <div class="col-sm-6">
	            <div class="breadcrumbs-area clearfix">
	                <h4 class="page-title pull-left">Admin Edit-{{ $admin->name }}</h4>
	                <ul class="breadcrumbs pull-left">
	                   <li><a href="{{ route('admin.index') }}">Dashboard</a></li>
	                    <li><a href="{{ route('admin.admins.index') }}">All Admin</a></li>
	                    <li><span> Edit Admins</span></li>
	                </ul>
	            </div>
	        </div>
	                ...
	                <div class="card-body">
	                   ...
	                   <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
		                       ...
		                       <div class="form-group col-md-6 col-sm-12">
		                           ...
		                           <input type="text" class="form-control" name="name" id="name" aria-describedby="emailHelp" placeholder="Enter your  name" value="{{ $admin->name }}">
		                       </div>

		                       <div class="form-group col-md-6 col-sm-12">
		                           <label for="email">Admin Email</label>
		                           <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Enter your  email" value="{{ $admin->email }}">
		                       </div>
	                       ...
	                       <div class="form-row">
		                       ...
		                       <div class="form-group col-md-6 col-sm-6">
		                           ...
		                           <input type="username" class="form-control" name="username" id="username" aria-describedby="emailHelp" placeholder="Enter your  Username" required="required" value="{{ $admin->username }}">
		                       </div>
	                       </div>
